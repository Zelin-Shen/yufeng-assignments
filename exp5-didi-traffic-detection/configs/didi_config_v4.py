...
launcher = 'none'
load_from = './work_dirs/cascade_rcnn_r50_fpn_1x_didi_improved/best_coco_bbox_mAP_epoch_20.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    outfile_prefix=
    'work_dirs/cascade_rcnn_r50_fpn_1x_didi_improved/test_results',
    type='CocoMetric')
test_pipeline = [
    dict(backend_args=None, type='LoadImageFromFile'),
    dict(keep_ratio=True, scale=(
...
val_evaluator = dict(
    ...
    outfile_prefix=
    'work_dirs/cascade_rcnn_r50_fpn_1x_didi_improved/val_results',
    type='CocoMetric')
vis_backends = [
...
work_dir = './work_dirs/cascade_rcnn_r50_fpn_1x_didi_improved'
