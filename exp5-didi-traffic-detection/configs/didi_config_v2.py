...
launcher = 'none'
load_from = './work_dirs/faster_rcnn_r50_fpn_1x_didi/best_coco_bbox_mAP_epoch_10.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    format_only=True,
    metric='bbox',
    outfile_prefix='work_dirs/test_predictions/results',
    type='CocoMetric')
test_pipeline = [
    dict(backend_args=None, type='LoadImageFromFile'),
    dict(keep_ratio=True, scale=(
...
val_evaluator = dict(
    ...
    outfile_prefix='work_dirs/detailed_eval/val_predictions',
    proposal_nums=(
        100,
        300,
        1000,
